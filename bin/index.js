#! /usr/bin/env node
"use strict";var J=Object.create;var A=Object.defineProperty;var Z=Object.getOwnPropertyDescriptor;var X=Object.getOwnPropertyNames;var $=Object.getPrototypeOf,ee=Object.prototype.hasOwnProperty;var re=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of X(e))!ee.call(r,s)&&s!==t&&A(r,s,{get:()=>e[s],enumerable:!(n=Z(e,s))||n.enumerable});return r};var v=(r,e,t)=>(t=r!=null?J($(r)):{},re(e||!r||!r.__esModule?A(t,"default",{value:r,enumerable:!0}):t,r));var R=(r=0)=>e=>`\x1B[${e+r}m`,B=(r=0)=>e=>`\x1B[${38+r};5;${e}m`,E=(r=0)=>(e,t,n)=>`\x1B[${38+r};2;${e};${t};${n}m`,i={modifier:{reset:[0,0],bold:[1,22],dim:[2,22],italic:[3,23],underline:[4,24],overline:[53,55],inverse:[7,27],hidden:[8,28],strikethrough:[9,29]},color:{black:[30,39],red:[31,39],green:[32,39],yellow:[33,39],blue:[34,39],magenta:[35,39],cyan:[36,39],white:[37,39],blackBright:[90,39],gray:[90,39],grey:[90,39],redBright:[91,39],greenBright:[92,39],yellowBright:[93,39],blueBright:[94,39],magentaBright:[95,39],cyanBright:[96,39],whiteBright:[97,39]},bgColor:{bgBlack:[40,49],bgRed:[41,49],bgGreen:[42,49],bgYellow:[43,49],bgBlue:[44,49],bgMagenta:[45,49],bgCyan:[46,49],bgWhite:[47,49],bgBlackBright:[100,49],bgGray:[100,49],bgGrey:[100,49],bgRedBright:[101,49],bgGreenBright:[102,49],bgYellowBright:[103,49],bgBlueBright:[104,49],bgMagentaBright:[105,49],bgCyanBright:[106,49],bgWhiteBright:[107,49]}},M=Object.keys(i.modifier),j=Object.keys(i.color),C=Object.keys(i.bgColor),N=[...j,...C];function te(){let r=new Map;for(let[e,t]of Object.entries(i)){for(let[n,s]of Object.entries(t))i[n]={open:`\x1B[${s[0]}m`,close:`\x1B[${s[1]}m`},t[n]=i[n],r.set(s[0],s[1]);Object.defineProperty(i,e,{value:t,enumerable:!1})}return Object.defineProperty(i,"codes",{value:r,enumerable:!1}),i.color.close="\x1B[39m",i.bgColor.close="\x1B[49m",i.color.ansi=R(),i.color.ansi256=B(),i.color.ansi16m=E(),i.bgColor.ansi=R(10),i.bgColor.ansi256=B(10),i.bgColor.ansi16m=E(10),Object.defineProperties(i,{rgbToAnsi256:{value(e,t,n){return e===t&&t===n?e<8?16:e>248?231:Math.round((e-8)/247*24)+232:16+36*Math.round(e/255*5)+6*Math.round(t/255*5)+Math.round(n/255*5)},enumerable:!1},hexToRgb:{value(e){let t=/[a-f\d]{6}|[a-f\d]{3}/i.exec(e.toString(16));if(!t)return[0,0,0];let[n]=t;n.length===3&&(n=[...n].map(d=>d+d).join(""));let s=Number.parseInt(n,16);return[s>>16&255,s>>8&255,s&255]},enumerable:!1},hexToAnsi256:{value:e=>i.rgbToAnsi256(...i.hexToRgb(e)),enumerable:!1},ansi256ToAnsi:{value(e){if(e<8)return 30+e;if(e<16)return 90+(e-8);let t,n,s;if(e>=232)t=((e-232)*10+8)/255,n=t,s=t;else{e-=16;let z=e%36;t=Math.floor(e/36)/5,n=Math.floor(z/6)/5,s=z%6/5}let d=Math.max(t,n,s)*2;if(d===0)return 30;let a=30+(Math.round(s)<<2|Math.round(n)<<1|Math.round(t));return d===2&&(a+=60),a},enumerable:!1},rgbToAnsi:{value:(e,t,n)=>i.ansi256ToAnsi(i.rgbToAnsi256(e,t,n)),enumerable:!1},hexToAnsi:{value:e=>i.ansi256ToAnsi(i.hexToAnsi256(e)),enumerable:!1}}),i}var ne=te(),c=ne;var f=v(require("node:process"),1),F=v(require("node:os"),1),S=v(require("node:tty"),1);function g(r,e=globalThis.Deno?globalThis.Deno.args:f.default.argv){let t=r.startsWith("-")?"":r.length===1?"-":"--",n=e.indexOf(t+r),s=e.indexOf("--");return n!==-1&&(s===-1||n<s)}var{env:l}=f.default,y;g("no-color")||g("no-colors")||g("color=false")||g("color=never")?y=0:(g("color")||g("colors")||g("color=true")||g("color=always"))&&(y=1);function se(){if("FORCE_COLOR"in l)return l.FORCE_COLOR==="true"?1:l.FORCE_COLOR==="false"?0:l.FORCE_COLOR.length===0?1:Math.min(Number.parseInt(l.FORCE_COLOR,10),3)}function oe(r){return r===0?!1:{level:r,hasBasic:!0,has256:r>=2,has16m:r>=3}}function ie(r,{streamIsTTY:e,sniffFlags:t=!0}={}){let n=se();n!==void 0&&(y=n);let s=t?y:n;if(s===0)return 0;if(t){if(g("color=16m")||g("color=full")||g("color=truecolor"))return 3;if(g("color=256"))return 2}if("TF_BUILD"in l&&"AGENT_NAME"in l)return 1;if(r&&!e&&s===void 0)return 0;let d=s||0;if(l.TERM==="dumb")return d;if(f.default.platform==="win32"){let a=F.default.release().split(".");return Number(a[0])>=10&&Number(a[2])>=10586?Number(a[2])>=14931?3:2:1}if("CI"in l)return"GITHUB_ACTIONS"in l?3:["TRAVIS","CIRCLECI","APPVEYOR","GITLAB_CI","BUILDKITE","DRONE"].some(a=>a in l)||l.CI_NAME==="codeship"?1:d;if("TEAMCITY_VERSION"in l)return/^(9\.(0*[1-9]\d*)\.|\d{2,}\.)/.test(l.TEAMCITY_VERSION)?1:0;if(l.COLORTERM==="truecolor"||l.TERM==="xterm-kitty")return 3;if("TERM_PROGRAM"in l){let a=Number.parseInt((l.TERM_PROGRAM_VERSION||"").split(".")[0],10);switch(l.TERM_PROGRAM){case"iTerm.app":return a>=3?3:2;case"Apple_Terminal":return 2}}return/-256(color)?$/i.test(l.TERM)?2:/^screen|^xterm|^vt100|^vt220|^rxvt|color|ansi|cygwin|linux/i.test(l.TERM)||"COLORTERM"in l?1:d}function k(r,e={}){let t=ie(r,{streamIsTTY:r&&r.isTTY,...e});return oe(t)}var le={stdout:k({isTTY:S.default.isatty(1)}),stderr:k({isTTY:S.default.isatty(2)})},I=le;function V(r,e,t){let n=r.indexOf(e);if(n===-1)return r;let s=e.length,d=0,a="";do a+=r.slice(d,n)+e+t,d=n+s,n=r.indexOf(e,d);while(n!==-1);return a+=r.slice(d),a}function L(r,e,t,n){let s=0,d="";do{let a=r[n-1]==="\r";d+=r.slice(s,a?n-1:n)+e+(a?`\r
`:`
`)+t,s=n+1,n=r.indexOf(`
`,s)}while(n!==-1);return d+=r.slice(s),d}var{stdout:P,stderr:H}=I,w=Symbol("GENERATOR"),p=Symbol("STYLER"),h=Symbol("IS_EMPTY"),Q=["ansi","ansi","ansi256","ansi16m"],m=Object.create(null),de=(r,e={})=>{if(e.level&&!(Number.isInteger(e.level)&&e.level>=0&&e.level<=3))throw new Error("The `level` option should be an integer from 0 to 3");let t=P?P.level:0;r.level=e.level===void 0?t:e.level};var ae=r=>{let e=(...t)=>t.join(" ");return de(e,r),Object.setPrototypeOf(e,b.prototype),e};function b(r){return ae(r)}Object.setPrototypeOf(b.prototype,Function.prototype);for(let[r,e]of Object.entries(c))m[r]={get(){let t=x(this,T(e.open,e.close,this[p]),this[h]);return Object.defineProperty(this,r,{value:t}),t}};m.visible={get(){let r=x(this,this[p],!0);return Object.defineProperty(this,"visible",{value:r}),r}};var O=(r,e,t,...n)=>r==="rgb"?e==="ansi16m"?c[t].ansi16m(...n):e==="ansi256"?c[t].ansi256(c.rgbToAnsi256(...n)):c[t].ansi(c.rgbToAnsi(...n)):r==="hex"?O("rgb",e,t,...c.hexToRgb(...n)):c[t][r](...n),ue=["rgb","hex","ansi256"];for(let r of ue){m[r]={get(){let{level:t}=this;return function(...n){let s=T(O(r,Q[t],"color",...n),c.color.close,this[p]);return x(this,s,this[h])}}};let e="bg"+r[0].toUpperCase()+r.slice(1);m[e]={get(){let{level:t}=this;return function(...n){let s=T(O(r,Q[t],"bgColor",...n),c.bgColor.close,this[p]);return x(this,s,this[h])}}}}var ge=Object.defineProperties(()=>{},{...m,level:{enumerable:!0,get(){return this[w].level},set(r){this[w].level=r}}}),T=(r,e,t)=>{let n,s;return t===void 0?(n=r,s=e):(n=t.openAll+r,s=e+t.closeAll),{open:r,close:e,openAll:n,closeAll:s,parent:t}},x=(r,e,t)=>{let n=(...s)=>ce(n,s.length===1?""+s[0]:s.join(" "));return Object.setPrototypeOf(n,ge),n[w]=r,n[p]=e,n[h]=t,n},ce=(r,e)=>{if(r.level<=0||!e)return r[h]?"":e;let t=r[p];if(t===void 0)return e;let{openAll:n,closeAll:s}=t;if(e.includes("\x1B"))for(;t!==void 0;)e=V(e,t.close,t.open),t=t.parent;let d=e.indexOf(`
`);return d!==-1&&(e=L(e,s,n,d)),n+e+s};Object.defineProperties(b.prototype,m);var pe=b(),Se=b({level:H?H.level:0});var o=pe;function me(){console.log(`
    ${o.redBright("/////////////////////////////////////////")}
    ${o.redBright("/////////////////////////////////////////")}
    ${o.redBright("////                                 ////")}
    ${o.redBright("////                                 ////")}
...
`,_=`node_modules
`,W=`import * as http from "node:http";
...
`;var u=v(require("node:fs"),1);u.default.mkdirSync("client");console.log(o.blue("./client directory created"));u.default.mkdirSync("client/TS",{recursive:!0});console.log(o.blue("./client/TS directory created"));u.default.mkdirSync("client/JS",{recursive:!0});console.log(o.blue("./client/JS directory created"));u.default.mkdirSync("client/CSS",{recursive:!0});console.log(o.blue("./client/CSS directory created"));u.default.mkdirSync("server");console.log(o.blue("./server directory created"));u.default.mkdirSync("server/dist",{recursive:!0});console.log(o.blue("./server/dist directory created"));u.default.writeFileSync("package.json",q);console.log(o.blue("package.json file written successfully"));u.default.writeFileSync("package-lock.json",G);console.log(o.blue("package-lock.json file written successfully"));u.default.writeFileSync("tsconfig.json",U);console.log(o.blue("tsconfig.json written successfully"));u.default.writeFileSync("README.md",Y);console.log(o.blue("README.md written successfully"));u.default.writeFileSync(".gitignore",_);console.log(o.blue(".gitignore written successfully"));u.default.existsSync("client")&&(u.default.writeFileSync("client/index.html",K),console.log(o.blue("index.html written successfully")));u.default.existsSync("server")&&(u.default.writeFileSync("server/server.ts",W),console.log(o.blue("server.ts written successfully")));D();
