...
`;function Z(){return process.argv[2]!==void 0?process.argv[2].replace(/[\/\\\s]+$/g,""):"Bad argument"}var u=y(require("node:fs"),1),g=Z();g!=="Bad argument"&&g!=="."?u.default.mkdirSync(g,{recursive:!0}):g=".";u.default.mkdirSync(g+"/client",{recursive:!0});console.log(o.blue("./client directory created"));u.default.mkdirSync(g+"/client/TS",{recursive:!0});console.log(o.blue("./client/TS directory created"));u.default.mkdirSync(g+"/client/JS",{recursive:!0});console.log(o.blue("./client/JS directory created"));u.default.mkdirSync(g+"/client/CSS",{recursive:!0});console.log(o.blue("./client/CSS directory created"));u.default.mkdirSync(g+"/server",{recursive:!0});console.log(o.blue("./server directory created"));u.default.mkdirSync(g+"/server/dist",{recursive:!0});console.log(o.blue("./server/dist directory created"));u.default.writeFileSync(g+"/package.json",G);console.log(o.blue("package.json file written successfully"));u.default.writeFileSync(g+"/package-lock.json",U);console.log(o.blue("package-lock.json file written successfully"));u.default.writeFileSync(g+"/tsconfig.json",Y);console.log(o.blue("tsconfig.json written successfully"));u.default.writeFileSync(g+"/README.md",_);console.log(o.blue("README.md written successfully"));u.default.writeFileSync(g+"/.gitignore",W);console.log(o.blue(".gitignore written successfully"));u.default.existsSync("client")&&(u.default.writeFileSync("client/index.html",J),console.log(o.blue("index.html written successfully")));u.default.existsSync("server")&&(u.default.writeFileSync("server/server.ts",K),console.log(o.blue("server.ts written successfully")));q();console.log("Instructions");console.log("           1.Run npm run buildServer");console.log("           2.Enter the http://localhost at the given port");console.log(g+"/");
